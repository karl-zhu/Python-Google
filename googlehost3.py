...
if __name__ == '__main__':
    ...
    htmlH      = urllib.request.urlopen('http://www.360kb.com/kb/2_150.html')
    html       = htmlH.read()
    print(html)
    reg        = r'#base services.*#google hosts 2016 end'
    hostHtmlRe = re.search(reg, html.decode('utf-8'), re.S)#因为在开头用了utf-8进行编码，这个位置需要解码，具体请参考官方文档
    ...
    hostOld    = f.read()
    reg        = re.compile(r'\r\n#google=.*#google hosts 2016 end', re.S)
